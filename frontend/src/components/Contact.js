  ...
  return (
    <section className='my-28' id='contact'>
      <header className='px-5 text-2xl font-bold pt-10'>
        <h2>Contact Me</h2>
        <p className='text-base font-thin'>I'd love to hear your thoughts! ❤️</p>
      </header>
      <div className='md:mx-6 flex flex-col flex-wrap md:flex-row justify-between'>
        <div className='md:w-6/12 md:px-0 p-5 my-5'>
          <div>
            <p className='font-bold'>Manas Dixit</p>
            <p className='font-thin'>Kanpur, India </p>
            <a href='mailto: manasjidixit@gmail.com' className='border-b-2 mt-3 inline-block border-gray-500'>
              manasjidixit@gmail.com
            </a>
          </div>
          <a className='border-b-2 mt-3 inline-block border-gray-500' href='./Resume - Manas Dixit.pdf' target='_blank' rel='noreferrer'>
            Resume
          </a>
          <div className='flex flex-row flex-wrap mt-7'>
            <div className='mr-4'>
              <a href='https://www.linkedin.com/in/dixitmanas' target='_blank' rel='noreferrer'>
            ...
            <div className='mr-4'>
              <a href='https://github.com/ManasDixit190164' target='_blank' rel='noreferrer'>
                <span className='mb-2 flex flex-row items-end border border-gray-500 p-2 rounded-lg text-sm'>
            ...
            <a href='https://telegram.me/m3nd7' target='_blank' rel='noreferrer'>
              <span className='mb-2 flex flex-row items-end border border-gray-500 p-2 rounded-lg text-sm'>
                <img src='./images/icons/tele.svg' alt='' width='24px' height='24px' className='mr-1' />
                Telegram
              </span>
            </a>
          </div>
